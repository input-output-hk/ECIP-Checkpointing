...
assert_morphoExample1 =
  ...
  where
    bytes = fromRight' $ bytesFromHex "5a1465f4683bf2c18fc72c0789239c0f52b3ceac666ca9551cf265a11abe912c"
    r = fromRight' $ bytesFromHex "f3af65a23fbf207b933d3c962381aa50e0ac19649c59c1af1655e592a8d95401"
    s = fromRight' $ bytesFromHex "53629a403579f5ce57bcbefba2616b1c6156d308ddcd37372c94943fdabeda97"
    v = 28
...
assert_morphoExample2 =
  ...
  where
    bytes = fromRight' $ bytesFromHex "2bb3925f178aa22c11435c61899e134fb7b1227016274b5f7b9d85c4469130ba"
    r = fromRight' $ bytesFromHex "fbe3df0cf030655d817a89936850d1cc00c07c35d3b21be73cfe9a730ea8b753"
    s = fromRight' $ bytesFromHex "62d73b6a92ac23ff514315fad795bbac6d485481d356329d71467e93c87dfa42"
    v = 31
    signature = Signature r s v
...
generateKP =
  ...
  where
    prvKey = fromRight' . importPrivateKey . integerToBytes 32 <$> d
