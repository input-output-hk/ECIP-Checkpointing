...
"""
This script is aimed to be used to mock the PoW Node RPC endpoint.
...
class PoWNodeRPCHandler(BaseHTTPRequestHandler):
...
def startServer():
    httpd = HTTPServer(("localhost",8546), PoWNodeRPCHandler)
